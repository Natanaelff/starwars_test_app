...
type screensStack = StackNavigationProp<RootStackParams, 'VehiclesDetails'>;
...
export function Vehicles(){
  ...
  const [listPeoples, setListPeoples] = useState<VehiclesProps[]>([]);
  ...
  return (
   <Container>
      <ViewLabel>
        ...
        <TextLabel>Veículos</TextLabel>  
      </ViewLabel>

      {
        listPeoples.map((item, index) => (
          <ViewNames key={index} onPress={() => navigation.navigate('VehiclesDetails', {details: item})}>
