...
export function StarshipsDetails(){
  ...
  return (
   <Container>
      <ViewLabel>
        ...
        <TextLabel>Detalhes da Nave estelar</TextLabel>  
      </ViewLabel>
      ...
      <ScrollView contentContainerStyle={{paddingBottom: RFValue(20)}}>
        ...
        <ViewNames>
          <TextName>Avaliação hiperdrive:</TextName>
          <SubTextName>{details?.hyperdrive_rating}</SubTextName>
        </ViewNames>

        <ViewNames>
          <TextName>MGLT:</TextName>
          <SubTextName>{details?.MGLT}</SubTextName>
        </ViewNames>

        <ViewNames>
          <TextName>Aula de nave estelar:</TextName>
          <SubTextName>{details?.starship_class}</SubTextName>
        </ViewNames>
